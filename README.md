...
Using standard [SQLITE 3](https://www.sqlite.org/index.html) database.

You need to create the `local_env.yml` from the sample, use your own TMDB API Read Access Token.
